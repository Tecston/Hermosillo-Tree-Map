...
const APP_CONFIG = {
  ...
  // (opcional) respaldo por género científico
  genusColors: {
...
canonicalSpecies(name) {
  // Mantén los nombres tal como vienen en el GeoJSON, sólo corrige mayúsculas/acentos
...
getGenus(species) {
  const sci = this.getScientificName(species);   // texto dentro de paréntesis
